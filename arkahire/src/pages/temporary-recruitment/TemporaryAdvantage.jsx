...
const advantages = [
  {
    ...
    image: work1,
    description:
      "We customize our recruitment strategies to align with your specific business needs.",
  },
  {
    title: "Industry Expertise",
    image: work2,
    description:
      "Our team possesses extensive experience across various industries, allowing us to understand and address your unique challenges.",
  },
  {
    title: "Commitment to Excellence",
    image: work3,
    description:
      "We are dedicated to delivering outstanding service and ensuring complete client satisfaction.",
  },
];
...
const TemporaryAdvantage = () => {
  ...
  const heading = ["The", "Arka", "Hire", "Advantage"];
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-14">
          ...
          <div ref={textRef}>
            ...
            <h2 className="max-w-xl text-[32px] font-black leading-[1.05] tracking-tight text-white drop-shadow-[0_10px_25px_rgba(0,0,0,0.4)] sm:text-[44px] lg:text-[54px]">
              Why Choose Arka Hire for Temporary Staffing?
            </h2>

            <p className="mt-5 max-w-xl text-[14px] font-bold leading-7 text-white/82">
              Partnering with Arka Hire for your temporary staffing needs means
              working with a team dedicated to your success. Our strategic
              approach ensures you receive high-quality candidates who integrate
              seamlessly into your business, helping you maintain productivity
        ...
        <div className="mt-24 text-center">
              ...
              >
                <span
                  className={`adv-word inline-block ${
                    word === "Advantage" ? "text-[#d8ffd8]" : "text-white"
          ...
          <p className="mx-auto mt-5 max-w-3xl text-[14px] font-semibold leading-7 text-white/78">
            We do more than just fill vacancies — we build lasting partnerships
            with our clients. Here’s what makes us stand out:
          </p>
        </div>
