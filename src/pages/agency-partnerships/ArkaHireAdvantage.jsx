...
const advantages = [
  {
    ...
    description:
      "Gain access to top-tier job openings and a broad network of reputable clients, ensuring continuous growth and success.",
    icon: icon1,
  },
  {
    title: "Collaborative Network",
    description:
      "Join a professional community of recruiters and industry experts dedicated to maintaining excellence in talent acquisition.",
    icon: icon2,
  },
  {
    title: "Professional Growth",
    description:
      "Expand your recruitment expertise with our support, resources, and guidance, helping you enhance your skills and grow your business effectively.",
    icon: icon3,
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <p className="adv-subtitle mx-auto mt-5 max-w-6xl text-[14px] font-bold leading-7 text-white/88 sm:text-[15px]">
            We have extensive expertise in the construction and hospitality
            sectors, allowing us to connect businesses with highly skilled
            candidates who are the perfect fit for their industry needs.
          </p>
        </div>
