...
const reasons = [
  {
    ...
    description: "Decades of experience in workforce solutions.",
  },
  {
    num: "02",
    title: "Global Reach",
    description: "Access to a worldwide network of skilled professionals.",
  },
  {
    num: "03",
  ...
  },
  {
    ...
    description: "Comprehensive assistance throughout the hiring process.",
  },
];
...
const WhyArkaHire = () => {
  ...
  const heading = ["4", "Reasons", "Why", "Partner", "with", "Arka", "Hire?"];
    ...
    >
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-16 max-w-4xl text-center">
          ...
          >
            A reliable recruitment partnership built on experience, reach,
            ...
            {reasons.map((item, index) => (
              ...
              >
                ...
                <div
                  ...
                  className="group relative w-full max-w-[220px] overflow-hidden rounded-2xl
