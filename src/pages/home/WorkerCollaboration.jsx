...
const WorkerCollaboration = () => {
  ...
  const title = ["Collaborating", "with", "Workers", "and", "Agencies"];

  const floatingCards = [
    {
      title: "👨‍💼 Exciting Opportunities for Global Careers",
      desc: "Join Arka Hire for rewarding career opportunities.",
      className: "lg:right-4 lg:top-5 xl:-right-25 xl:top-2",
    },
    {
      title: "🤝 Collaborate with HR Experts & Visa",
      desc: "Partner with us to efficiently meet industry demands.",
      className: "lg:right-16 lg:top-[145px] xl:-right-10 xl:top-[165px]",
    },
    {
      title: "👷 Let’s Collaborate",
      desc: "Together, we can create successful and sustainable employment solutions.",
      className: "lg:right-4 lg:bottom-8 xl:-right-25 xl:bottom-2",
    },
  ];
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.88fr_1.12fr]">
        ...
        <div>
          ...
          <div className="space-y-4 text-[15px] font-medium leading-7 text-white/90 sm:text-[16px]">
            <p className="wc-text">
              We welcome skilled workers and agencies to partner with us. We
              value your expertise and commitment.
            </p>

            <p className="wc-text">
              Together, we can effectively meet industry demands. By
              collaborating with us, you will be part of a network that ensures
              steady and rewarding opportunities.
            </p>

            <p className="wc-text">
              We prioritize maintaining high standards of workforce quality,
              offering the best matches for your skills and needs.
            </p>

            <p className="wc-text">
              Let’s join forces to create successful and sustainable employment
              solutions. Become part of a dynamic and thriving recruitment
              ecosystem.
            </p>
          </div>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            >
              <span className="relative z-10">Job Seekers Apply Here</span>
            ...
            >
              <span className="relative z-10">Agents Please Contact Us</span>
              <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent transition duration-500 group-hover:translate-x-full" />
            </a>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          >
            <img
              src={colabortion}
              alt="Collaboration with workers and agencies"
          ...
          <div className="hidden lg:block">
            {floatingCards.map((card, index) => (
              <div
                ...
                className={`absolute w-[350px] rounded-xl border-[6px] border-white/35 bg-[#096111]/50 p-4 text-white shadow-[0_18px_40px_rgba(0,0,0,0.35)] backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:bg-[#0b7415] ${card.className}`}
              >
