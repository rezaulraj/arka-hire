...
const icons = [sourcingIcon, screeningIcon, targetedIcon, improvementIcon];
...
const OurStrategiesSereening = () => {
  ...
  const cardsData = t("ourApproach.ourStrategiesScreening.cards", {
    returnObjects: true,
  });
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-gradient-to-r from-[#0C1A0E] via-[#2f7f35] to-[#0C1A0E] px-4 py-16 sm:px-6 lg:px-20 font-montserrat text-white"
    >
      <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-12 drop-shadow-lg">
        {t("ourApproach.ourStrategiesScreening.heading")}
      </h2>
      ...
      <div className="flex flex-col gap-12">
        {strategies.map((strategy, idx) => (
          ...
          >
            <div className="flex items-center justify-center h-24 w-24 rounded-xl bg-[#3a8d48] shadow-lg shrink-0">
              <img
                src={strategy.icon}
                alt={strategy.title}
